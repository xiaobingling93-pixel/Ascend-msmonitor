...
## 💻 版本说明
msMonitor由三个文件组成，其中dyno和dynolog可以被打包为deb包或者rpm包。最新的预编译安装包和版本依赖请参见《[版本说明](./docs/zh/release_notes.md)》。目前msMonitor支持在[PyTorch](https://gitcode.com/Ascend/pytorch)框架和[MindSpore](https://www.mindspore.cn/)框架上运行。 
...
## 🔧 环境部署
安装msMonitor工具。详情请参见《[msMonitor安装指南](./docs/zh/install_guide.md)》，推荐使用下载软件包安装。
...
## 📖 特性介绍
⚠️ 由于底层资源限制，npu-monitor功能和nputrace不能同时开启。
...
## ❓ FAQ
[msMonitor FAQ](./docs/zh/faq.md)

## 🔒 安全声明
MindStudio-Monitor产品的安全加固信息、公网地址信息等内容。详情请参见《[安全声明](./docs/zh/security_statement.md)》。

## 🔑 License
MindStudio-Monitor产品许可证。详见[LICENSE](./LICENSE)文件。
